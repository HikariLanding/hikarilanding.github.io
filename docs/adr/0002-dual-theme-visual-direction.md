...
- ➡️ 本条动效条款已被修订（2026-07-18）：「切换过渡只写 body/图标/光晕」升级为全元素同拍，「reduced-motion 全站禁用」改为分级降级（保留颜色/opacity 过渡）。终值与理由见 **docs/adr/0003（动效系统）**；本条其余内容（开关形态、`--glow-strength` 手法、语义超载警告）仍然有效。
